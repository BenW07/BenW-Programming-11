public class Main {
    ...
    /*for line 33, I wrote '81' as '81.0' so that it would calculate as a float instead
    of an integer and have a consistent output. If there is a better way of doing this please tell me :) */
        //Expression 4
        ...
        //Expression 5
        System.out.println(((14.0 / 2 + 3) * Math.sin(45) + 2) - Math.pow(Math.sqrt(25), 3));
